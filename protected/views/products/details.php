...
<?php Yii::app()->getClientScript()->registerScriptFile(Yii::app()->baseUrl.'/js/jquery.scrollTo.js');?>
...
<?php Yii::app()->getClientScript()->registerScript('scrollTo','$(document).ready(function () {
