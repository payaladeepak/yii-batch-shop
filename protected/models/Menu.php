...
class Menu extends CActiveRecord
{
    ...
    public function rules() {
        ...
        return array(array('name','required'),array('name','length','max'=>64),// The following rule is used by search().
	...
	public function relations()
	{
		...
		// class name for the relations automatically generated below.
            return array('products'=>array(self::HAS_MANY,'Product','menu_id'));
